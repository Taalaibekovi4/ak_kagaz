// src/page/catalog/SaleProductsPage.jsx
...
// cюда добавил oldPrice / discount / promotion
...
const SaleProductsPage = ({ onAddToCart = () => {} }) => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const params = { page: currentPage, promotion: true }; // только акционные
