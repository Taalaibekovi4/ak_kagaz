// src/page/homePage/components/Main/SaleProducts.jsx
import React, { useEffect, useRef, useState } from "react";
import FiguraTop from "../../../../assets/SaleProducts/1gifuraak.svg";
import FiguraBottom from "../../../../assets/SaleProducts/2gifuraak.svg";
import NextIcon from "../../../../assets/SaleProducts/next.svg";
import PrevIcon from "../../../../assets/SaleProducts/peret.svg";
import Cart from "../../../../page/ui/Cart";

import ProductImg from "../../../../assets/SaleProducts/note.svg";
import { getProducts } from "../../../../api/catalog";

// Добавили oldPrice / discount / promotion
...
const SaleProducts = ({ onAddToCart = () => {} }) => {
  ...
  // грузим товары с акцией ТОЛЬКО с бэка
  useEffect(() => {
    let cancelled = false;
    ...
    <section className="relative w-full bg-white overflow-hidden">
      ...
      <img
        ...
        className="
          ...
          w-[260px] sm:w-[460px] lg:w-[690px]
          h-auto
        "
      />

      <div className="relative z-10 mx-auto max-w-[1200px] px-3 sm:px-4 pb-[260px]">
        {/* Заголовок */}
        <h2
          className="
            pt-[80px] sm:pt-[110px] lg:pt-[136px]
        ...
        {/* Навигация для маленьких экранов (кнопки над лентой) */}
          ...
          >
            ...
            {products.map((p) => (
              <div
                ...
                "
              >
                {/* передаём всю акционную инфу в Cart */}
